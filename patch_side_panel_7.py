...
new_code = """            <div style="background: #f8fafc; display: flex; flex-direction: column;">
                <div style="padding: 20px; padding-bottom: 15px; display: flex; flex-direction: column; gap: 12px;">"""
...
if re.search(old_code, html):
    ...
    with open("index.html", "w") as f:
        f.write(html)
    print("Patched side panel 7 successfully")
else:
    print("Failed to patch side panel 7 - pattern not found")
